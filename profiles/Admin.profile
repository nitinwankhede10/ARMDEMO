...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Test_SDC__c.DevA_field__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
        <field>Test_SDC__c.DevB_field__c</field>
        <readable>false</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
    ...
    <layoutAssignments>
        <layout>Campaign-Kampagnenlayout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Case-Kundenvorgangslayout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Contact-Kontaktlayout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Idea-Ideenlayout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>OpportunityLineItem-Opportunityproduktlayout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Order-Auftragslayout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>OrderItem-Reihenfolge für Auftragsprodukte</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Product2-Produktlayout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Test_SDC__c-Test_SDC Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>User-Benutzerlayout</layout>
    </layoutAssignments>
    <layoutAssignments>
